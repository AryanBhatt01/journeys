...
var Share = /** @class */ (function(_super) {
        ...
        switch (e.keyCode || e.charCode) {
            ...
            case 13: // enter
                ...
                if (this.state.showShare) {
                    ...
                    this.props.actions.eventsListener(INFO_EVENTS.SHARE_BUTTON_CLICKED, shareData);
                    this.props.actions.toggleShare(e, false);
                    utils.setStateAndLog(this, 'Share Keypress', {
                        showShare: false,
                        focusedShareIcon: 0,
    ...
    Share.prototype.getShareItem = function(network, idx) {
        ...
        return (React.createElement("button", {
                className: "has-custom-focus network-".concat(idx + 1) +
                ...
                style: {
                    top: this.props.isVerticalContainer ?
                        "calc(100% / 6 * ".concat(idx + 1, " + -10px ").concat(shareIconsNumber === 4 ? '+ 100% / 12' : '', ")") :
                        '',
                ...
                onClick: function(e) {
                    ...
                    _this.props.actions.eventsListener(INFO_EVENTS.SHARE_BUTTON_CLICKED, shareData);
                },
    ...
    Share.prototype.render = function() {
        ...
        if (options.allowSocial) {
            ...
            return (React.createElement("div", {
                ...
                className: 'info-member info-element-social-share-box ' +
