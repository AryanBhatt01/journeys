...
var InfoElement = /** @class */ (function(_super) {
    ...
    function InfoElement(props) {
        ...
        _this.createAboveBelowRightLeftInfoElement = _this.createAboveBelowRightLeftInfoElement.bind(_this);
        _this.createSlideshowInfoElement = _this.createSlideshowInfoElement.bind(_this);
        return _this;
    }
    InfoElement.prototype.shouldShowHoverOnMobile = function() {
        ...
        if (isMobile) {
            ...
            if (hoveringBehaviour === GALLERY_v4_CONSTS.infoBehaviourOnHover.NEVER_SHOW) {
                return false;
            }
            if (itemClick === 'nothing' && this.props.type !== 'video') {
                return true;
            } else if ((allowTitle || allowDescription) &&
    ...
    InfoElement.prototype.itemHasLink = function() {
        var _a = this.props,
            ...
            linkUrl = _a.linkUrl;
        var itemDoesntHaveLink = (!linkData || linkData.type === undefined) &&
    ...
    InfoElement.prototype.toggleShare = function(event, forceVal) {
        ...
        if (this.props.shouldUseNewSocialSharePopup) {
            this.props.actions.eventsListener(INFO_EVENTS.SOCIAL_SHARE_BUTTON_CLICKED, __assign({
                showSocialSharePopup: true
            }, this.props));
        } else {
            this.setState({
    ...
    InfoElement.prototype.getShare = function() {
        return (React.createElement(Share, __assign({}, this.props, {
    ...
    InfoElement.prototype.getSocial = function() {
        return (React.createElement(Social, __assign({}, this.props, {
            showShare: this.state.showShare,
    ...
    InfoElement.prototype.getInfoContainerStyles = function() {
        ...
        if (infoType === EXTERNAL_INFO_TYPE.EXTERNAL) {
            ...
            infoStyles = __assign(__assign({}, infoStyles), {
                cursor: options.itemClick === GALLERY_v4_CONSTS.itemClick.NOTHING ||
    ...
    InfoElement.prototype.createHoverInfoElement = function() {
        ...
        var hoverStyles = {
            ...
            paddingTop: (options.galleryVerticalAlign !== 'center' ?
                options.textsVerticalPadding :
                0) + 'px',
            paddingBottom: (options.galleryVerticalAlign !== 'center' ?
                options.textsVerticalPadding :
                0) + 'px',
        };
        var itemTexts = GALLERY_v4_CONSTS.hasHoverPlacement(options.titlePlacement) &&
    ...
    InfoElement.prototype.createSlideshowInfoElement = function() {
        ...
        return (React.createElement("div", {
            ...
            React.createElement("div", {
                    style: innerStyle,
                    className: "slideshow-info-element-inner"
                },
                social,
                itemTexts)));
    };
