...
var CustomImageRenderer = /** @class */ (function(_super) {
    ...
    CustomImageRenderer.prototype.render = function() {
        ...
        if (typeof props.src === 'string') {
            ...
            var imageHtmlProps = omitImagetNonHTMLProps(imageProps);
            return (React.createElement("picture", {
                    key: "multi_picture_".concat(props.id)
                },
                props.src.map(function(currentSrc, index) {
...
function omitImagetNonHTMLProps(imageProps) {
    var propsToFilter = [
        'allowChanges',
        'priorityLoading',
        'customImageRenderer',
