...
var ItemActions = /** @class */ (function() {
    function ItemActions() {
        ...
        this.loveCounts = {};
        this.fetchSiteInfo();
        this.isRemoveUseOfCounterApiEnabled = true;
    }
    ...
    ItemActions.prototype.setItemsLoveData = function(config) {
        ...
        if (itemsLoveData) {
            ...
            var parsedLovedItems = void 0;
            if (reactionService.shouldUseNewParsing()) {
                parsedLovedItems = reactionService.newParseReactionServiceResponse(itemsLoveData);
            } else {
                parsedLovedItems = reactionService.parseReactionServiceResponse(itemsLoveData);
            }
            ...
            return __generator(this, function(_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        fetch("".concat(this.baseUrl, "/_api/pro-gallery-webapp/v1/gallery/").concat(this.galleryId, "/stats/properties"))
                            .then(function(res) {
                                return res.json();
                            })
                            .then(function(res) {
    ...
    ItemActions.prototype.migrateLoveDataFromStatsToReactionService = function() {
        return __awaiter(this, void 0, void 0, function() {
            var loveCountsReactionService, error, loveCountsStatsApi, loveCountsStatsApi, mergedItemsPromises, _i, _a, _b, photoId, count, mergedItemsReponses, index, error, error, e_1, error;
            return __generator(this, function(_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        if (!!this.isRemoveUseOfCounterApiEnabled) return [3 /*break*/ , 3];
                    ...
                    case 2:
                        ...
                        _c.label = 3;
                    case 3:
                        if (!(Object.keys(loveCountsReactionService).length === 0)) return [3 /*break*/ , 7];
                        if (!!this.isRemoveUseOfCounterApiEnabled) return [3 /*break*/ , 7];
                        return [4 /*yield*/ , this.getLoveDataUsingStatsApi()];
                    case 4:
                        loveCountsStatsApi = _c.sent();
                        if (!(Object.keys(loveCountsStatsApi).length > 0)) return [3 /*break*/ , 7];
                        ...
                        mergedItemsPromises = [];
                        for (_i = 0, _a = Object.entries(loveCountsStatsApi); _i < _a.length; _i++) {
                    ...
                    case 6:
                        ...
                        if (!baseUtils.isSubset(loveCountsStatsApi, loveCountsReactionService)) {
                            if (typeof this.sentryReport === 'function') {
                                index = mergedItemsReponses.findIndex(function(res) {
                                    return res.status.toString() !== '200';
                                });
                                if (index > -1) {
                                    error = "Reaction-Service error - migrating data failed - ".concat(mergedItemsReponses[index].status, " : ").concat(mergedItemsReponses[index].message);
                                    this.sentryReport(error);
                                } else {
            ...
            return __generator(this, function(_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/ ];
                    case 2:
                        return [4 /*yield*/ , fetch("".concat(this.baseUrl, "/_api/pro-gallery-webapp/v1/gallery/").concat(this.galleryId, "/").concat(instanceId, "/stats"))];
                    case 3:
                        res = _a.sent();
    ...
    ItemActions.prototype.getLoveDataWithOriginalFunction = function() {
        ...
        if (!instanceId) {
            ...
            fetch("".concat(this.baseUrl, "/_api/pro-gallery-webapp/v1/gallery/").concat(this.galleryId, "/").concat(instanceId, "/stats"))
                .then(function(res) {
                    return res.json();
                })
                .then(function(res) {
    ...
    ItemActions.prototype.getReachLevel = function(increment) {
        ...
        if (_.isUndefined(this.reachLevel)) {
            ...
            rl = Number(ls["".concat(this.siteUrl, "|reach-level")] || 0) + inc;
        } else {
    ...
    ItemActions.prototype.setReachLevel = function(rl) {
        ...
        try {
            ...
            if (rl > 0 && origRl === 0 && _.isUndefined(this.reachLevel)) {
                var ls = baseUtils.getLocalStorage();
                ls["".concat(this.siteUrl, "|reach-level")] = rl;
                this.reachLevel = rl;
            }
        } catch (e) {
    ...
    ItemActions.prototype.getShareUrl = function(item) {
        var galleryIdentifier = this.shouldUseGalleryIdForShareUrl ?
            this.galleryId + '_' :
            this.compId.replace('comp-', '') + '-';
        return this.pageUrl + '?pgid=' + galleryIdentifier + this.getItemId(item);
    };
    ...
    ItemActions.prototype.shareImp = function(type, itemDto, callback) {
        ...
        var shareMessage = encodeURIComponent("".concat(this.getShareUrl(item)));
    ...
    ItemActions.prototype.toggleLove = function(photoId, forceVal) {
        ...
        try {
            ...
            if (typeof this.sentryReport === 'function') {
                var error = "Reaction Service error - couldn't toggle love data in gallery: ".concat(this.galleryId, " item: ").concat(photoId);
                this.sentryReport(error);
            }
        }
        if (!this.isRemoveUseOfCounterApiEnabled) {
