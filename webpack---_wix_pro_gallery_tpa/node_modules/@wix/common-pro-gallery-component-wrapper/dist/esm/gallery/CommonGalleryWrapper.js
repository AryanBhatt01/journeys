...
var CommonGalleryWrapper = /** @class */ (function(_super) {
    ...
    function CommonGalleryWrapper(props) {
        ...
        _this.state.isAccessible = _this.accessibilityHelper.getIsAccessible();
    ...
    CommonGalleryWrapper.prototype.componentDidMount = function() {
        ...
        this.setAccessibilityState(this.accessibilityHelper.getIsAccessible());
    ...
    CommonGalleryWrapper.prototype.componentWillReceiveProps = function(props) {
        ...
        this.setAccessibilityState(this.accessibilityHelper.getIsAccessible());
        this.fullscreenHelper.openFullscreenByProps(__assign(__assign({}, props.host), props));
        this.fullscreenHelper.openDirectFullscreen();
    };
    ...
    CommonGalleryWrapper.prototype.onNewProps = function(props) {
        ...
        this.itemsHelper.loadDirectFullscreenItemDimensionsIfNeeded();
    ...
    CommonGalleryWrapper.prototype.render = function() {
        ...
        if (this.canRender({
            ...
            if (shouldRenderGallery) {
                ...
                }), this.getProGalleryElement(React.createElement(ProGalleryRendererWrapper, __assign({
                    key: 'pro-gallery-renderer-wrapper'
                }, this.pgProps))));
            } else {
                ...
                if (noItemsToRender &&
                    ...
                    if (GalleryEmpty) {
                        ...
                        }, React.createElement(GalleryEmpty, null)));
                    }
                }
            }
            ...
            dom.push(React.createElement(SocialShareWrapper, {
                key: 'pro-gallery-social-share-wrapper',
            ...
            if (shouldRenderGallery && AccessabilityTooltipComponent) {
                dom.push(React.createElement(AccessabilityTooltipComponent, {
                    key: 'pro-gallery-accessability-tooltip',
            ...
            rawStyle = responsiveGallery ?
                "".concat(galleryClassSelector, " {\n        height: 100%;\n        width: 100%;\n        position: relative;\n      }\n      ").concat(galleryClassSelector, " #gallery-wrapper-").concat(id, " {\n        position: absolute;\n        top: 0;\n        left: 0;\n      }") :
                "".concat(galleryClassSelector, " {\n      width: 100%;\n      }\n      ");
        } else {
            dom = [];
            dom.push(this.createRenderIndicator({
