...
var DimensionsHelper = /** @class */ (function() {
    ...
    DimensionsHelper.prototype.observeResize = function() {
        ...
        if (this.parent.galleryWrapperElementRef) {
            this.observingResize = true;
            this.resizeObserver.observe(this.parent.galleryWrapperElementRef);
        }
    };
    ...
    DimensionsHelper.prototype.observeIntersection = function() {
        ...
        try {
            if (this.parent.galleryWrapperElementRef) {
                ...
                this.intersectionObserver.observe(this.parent.galleryWrapperElementRef);
            }
        } catch (e) {
    ...
    DimensionsHelper.prototype.calcBoundingRect = function() {
        ...
        try {
            return this.getBoundingBox(this.parent.galleryWrapperElementRef);
        } catch (e) {
    ...
    DimensionsHelper.prototype.calcBodyBoundingRect = function() {
        ...
        try {
            ...
            if (popupRootElement &&
                this.parent.galleryWrapperElementRef &&
                popupRootElement.contains(this.parent.galleryWrapperElementRef)) {
