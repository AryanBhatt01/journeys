...
var AccessibilityHelper = /** @class */ (function() {
    function AccessibilityHelper(galleryWrapper, props, setAccessibilyState) {
        ...
        this.getIsAccessible = this.getIsAccessible.bind(this);
    ...
    AccessibilityHelper.prototype.getIsAccessible = function() {
        return (this.galleryWrapperProps.accessibilityEnabled ||
