...
var useTransparentPlayButtonAndForceLoadVideo = function(props) {
    return ((props.videoUrl || props.url).includes('youtube.com') ||
    ...
    VideoItemWrapper.prototype.createVideoPlaceholder = function(showVideoPlayButton) {
        ...
        return (React.createElement(VideoItemPlaceholder, __assign({}, props, {
            ...
            videoPlayButton: showVideoPlayButton &&
                !this.state.videoItemLoaded && (React.createElement(VideoPlayButton, {
    ...
    VideoItemWrapper.prototype.componentDidMount = function() {
        return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(_a) {
                switch (_a.label) {
                    case 0:
                        if (!(!isEditMode() && this.mightPlayVideo())) return [3 /*break*/ , 4];
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/ ,
