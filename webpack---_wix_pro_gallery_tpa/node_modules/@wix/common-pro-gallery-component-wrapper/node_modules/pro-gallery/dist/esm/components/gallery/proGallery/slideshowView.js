...
var SlideshowView = /** @class */ (function(_super) {
    ...
    SlideshowView.prototype.getFirstIdx = function(itemIdx) {
        var galleryItems = this.props.galleryStructure.galleryItems;
        var activeItemId = galleryItems[itemIdx].itemId;
    ...
    SlideshowView.prototype.scrollToThumbnail = function(itemIdx, scrollDuration) {
        ...
        var activeIdx = this.state.activeIndex;
        var targetIdx = activeIdx + (this.getFirstIdx(itemIdx) - this.getFirstIdx(activeIdx));
        this.scrollToIndex({
            itemIdx: targetIdx,
            scrollDuration: scrollDuration,
