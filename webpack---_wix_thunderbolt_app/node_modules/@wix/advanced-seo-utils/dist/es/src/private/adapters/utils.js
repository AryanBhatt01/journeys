...
import {
    calculateOpeningHoursSpecifications
} from './calculated/calculate-opening-hours-specifications';
import {
    getRestaurantImages
} from './calculated/get-resturants-images';
...
export var getSiteData = function(item) {
    ...
    var data = (_a = {},
        ...
        _a);
    var restaurantsMenuPageData = (_b = {},
...
var getExperiments = function(item) {
    ...
    if (platformAppsExperiments) {
        platformAppsExperiments = Object.values(platformAppsExperiments).reduce(function(acc, experiments) {
