! function(e, t) {
    ...
    return (() => {
        ...
        for (var d = [], p = 0; p < 256; ++p) d.push((p + 256).toString(16).substr(1));
        const l = function(e) {
        ...
        const f = {
            ...
            h = e => {
                ...
                }))), r.price || r.value || r.revenue || (r.price = (e => (Number.parseFloat(e.tax) || 0) + (Number.parseFloat(e.shipping) || 0) + e.contents.reduce(((e, t) => e + Number.parseFloat(t.item_price) * t.quantity), 0))(r).toString()), r.currency || (r.currency = (e => e.contents && e.contents[0].currency)(r))), g(r, f)
            },
            C = e => {
                ...
                Purchase: (e, t) => {
                    if (t.isFBServerEventsEnabled) {
                        const t = { ...h(C(e)),
                            ...
                            n = (e => e.origin === y ? e.orderId : e._internalEventId)(e),
                            r = ["track", "Purchase", { ...t
                            }, {
                                eventID: n
                            }],
        ...
        const A = e => e ? `Enhanced Ecommerce - ${e}` : "Enhanced Ecommerce",
            E = {
                ...
                AddProductImpression: e => {
                    const t = (e.contents || []).map((e => ["ec:addImpression", g(e, b)]));
                    return [
                        ["require", "ec"]
                    ].concat(t).concat([
                ...
                InitiateCheckout: e => {
                    const t = (e.contents || []).map((e => ["ec:addProduct", g(e, b)])),
                        n = g({
                            option: e.option
                        }, b);
                    return [
        ...
        const R = Object.keys(L).reduce(((e, t) => {
                let {
                    name: n,
                    table: r,
                    paramsMap: o
                ...
                return e[t] = function(e, i) {
                    return void 0 === e && (e = {}), "function" == typeof n && (n = n(e)), o && (e = Object.keys(o).reduce(((t, n) => (t[o[n]] = e[n], t)), {})), n = n || t, N(n, e, i, r)
                }, e
            }), {
                CustomEvent: (e, t) => {
                    let {
        ...
        const F = Object.keys(V).reduce(((e, t) => (e[t] = function(e, n) {
                ...
                return n.context && n.context.appDefId && (r.appId = n.context.appDefId), n.preventDefaultChannels ? [] : ("Purchase" === t && (r.features = w({
                    reportedToFBonClient: !_(e)
                })), [
                    [r]
                ])
            }, e)), {}),
        ...
        (() => {
            for (let e = 1; e <= 200; e++) j["dimension" + e] = "dimension" + e, j["metric" + e] = "metric" + e
        })();
        const Y = {
                PageView: (e, t) => {
                    let {
            ...
            Q = function(e) {
                return void 0 === e && (e = []), e.map((e => ({ ...g(e, H),
                    content_type: "product"
                })))
            },
            Z = function(e) {
        ...
        const ae = (e, t) => {
                var n, r;
                n = re, r = e, Object.prototype.hasOwnProperty.call(n, r) || (re[e] = t)
            },
            ce = (e, t) => {
        ...
        const ye = new class {
                constructor(e) {
                    ...
                    void 0 === e && (e = []), i()(this, "_channels", []), i()(this, "_listeners", []), i()(this, "addChannel", (e => {
                        ...
                        m(this._channels.filter((e => !pe[e.name])), e, t, n)
                ...
                populateChannelEvents(e) {
                    e.events = ve[e.name], e.events.publicTracking && e.events.publicTracking instanceof Function && e.events.publicTracking()
                }
                isChannelValid(e) {
                    const t = e.name,
                        n = e.report,
