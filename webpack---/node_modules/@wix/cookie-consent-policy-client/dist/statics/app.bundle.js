...
(() => { // webpackBootstrap
    ...
    var __webpack_modules__ = ({
        ...
        290:
            ...
            ((module, __unused_webpack_exports, __webpack_require__) => {
                ...
                var toPropertyKey = __webpack_require__( /*! ./toPropertyKey.js */ 739);
        ...
        64:
            ...
            ((module, __unused_webpack_exports, __webpack_require__) => {
                ...
                var _typeof = (__webpack_require__( /*! ./typeof.js */ 425)["default"]);
        ...
        739:
            ...
            ((module, __unused_webpack_exports, __webpack_require__) => {
                ...
                var _typeof = (__webpack_require__( /*! ./typeof.js */ 425)["default"]);
                var toPrimitive = __webpack_require__( /*! ./toPrimitive.js */ 64);
    ...
    (() => {
        ...
        function readCookieData(cookeName) {
            ...
            return (cookieData == null || (_cookieData$pop = cookieData.pop()) == null ? void 0 : _cookieData$pop.replace(';', '')) || void 0;
        }

        function enabledExperiment(specName) {
            var _window, _window2;
            if (typeof((_window = window) == null || (_window = _window.wixTagManager) == null ? void 0 : _window.getConfig) !== 'function') {
                return false;
            }
            return ((_window2 = window) == null || (_window2 = _window2.wixTagManager) == null || (_window2 = _window2.getConfig()) == null || (_window2 = _window2.experiments) == null ? void 0 : _window2[specName]) === 'true';
        }
        // EXTERNAL MODULE: ../../node_modules/@babel/runtime/helpers/defineProperty.js
        var defineProperty = __webpack_require__(290);
        var defineProperty_default = /*#__PURE__*/ __webpack_require__.n(defineProperty);; // CONCATENATED MODULE: ./js/xhr-driver.ts
        ...
        function publishEvent(eventName, publishingNode, eventData) {
            let customEvent; // @ts-expect-error
        ...
        class ConsentPolicyManager {
            constructor() {
                ...
                defineProperty_default()(this, "init", options => {
                    ...
                    const triggerConsentPolicyChanged = this.shouldTriggerConsentPolicyChanged(config);
                    this.initRan = true;
                ...
                defineProperty_default()(this, "setConsentPolicy", (policy, successCallback, errorCallback, accessToken) => {
                    if (policy === void 0) {
                    ...
                    xhrPost(getAPIBase(this.config.baseUrl), successCB, errCB, policyString, accessToken || '');
                });
        ...
        function createPolicyInstance() {
            (function() {
                const functionKeys = ['getCurrentConsentPolicy', 'resetPolicy', '_getConsentPolicyHeader', 'publishPolicyUpdateRequestedEvent'];
                const dataKeys = ['initRan', 'hostname'];
                const publicAPI = {};
                const consentPolicyInstance = new ConsentPolicyManager();
                functionKeys.forEach(key => {
                    publicAPI[key] = function() { // @ts-expect-error
                        return consentPolicyInstance[key].apply(consentPolicyInstance, Array.from(arguments));
                    };
                });
                dataKeys.forEach(key => {
                    Object.defineProperty(publicAPI, key, { // @ts-expect-error
                        get: () => consentPolicyInstance[key],
                        set: value => {
                            if (key === 'hostname') {
                                consentPolicyInstance[key] = value;
                            }
                        }
                    });
                });
                let appTokenAccessor;
                publicAPI.init = (options, getAppToken) => { // @ts-expect-error
                    appTokenAccessor = getAppToken || undefined;
                    return consentPolicyInstance.init(options);
                };
                publicAPI.setConsentPolicy = async (newPolicy, successCallback, errorCallback) => {
                    let accessToken = '';
                    if (typeof appTokenAccessor === 'function') {
                        try {
                            accessToken = await appTokenAccessor();
                        } catch (e) {
                    ...
                    return consentPolicyInstance.setConsentPolicy(newPolicy, successCallback, errorCallback, accessToken);
                };

                function localAccessToken() {
                    const embedsAPI = window.wixEmbedsAPI;
                    return !isWix() && embedsAPI && embedsAPI.getAppToken && embedsAPI.getAppToken(APP_DEF_ID);
                }
